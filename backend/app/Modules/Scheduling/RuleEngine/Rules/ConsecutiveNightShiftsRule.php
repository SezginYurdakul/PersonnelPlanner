...
/**
 * Skeleton for a future rule (ProjectPlan.md §16.3): a limit on how many night shifts an
 * employee can work in a row. Registered disabled in config/scheduling_rules.php, so
 * RuleEngine never calls evaluate() in normal operation.
 */
final class ConsecutiveNightShiftsRule implements SchedulingRule
{
    public function key(): string
    {
        return 'consecutive_night_shifts';
    }
